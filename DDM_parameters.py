...
# TEMPORARY: For testing and comparing to simulations.
# setting_list = [['linear_xt', 'linear_xt', 'constant'], ['linear_xt', 'sinx_cost', 'collapsing_exponential']]           #Define various setting specs for each task...
