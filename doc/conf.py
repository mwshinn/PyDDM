...
latex_documents = [
    (master_doc, 'PyDDM.tex', 'PyDDM Documentation',
     'Maxwell Shinn, Norman Lam', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyddm', 'PyDDM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyDDM', 'PyDDM Documentation',
     author, 'PyDDM', 'One line description of project.',
     'Miscellaneous'),
]
